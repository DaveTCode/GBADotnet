...
internal struct Bldcnt
{
    ...
    internal void Set(ushort val)
    {
        ...
        Bg2ndTargetPixel[0] = (val & 1 << 8) != 0;
        Bg2ndTargetPixel[1] = (val & 1 << 9) != 0;
        Bg2ndTargetPixel[2] = (val & 1 << 10) != 0;
        Bg2ndTargetPixel[3] = (val & 1 << 11) != 0;
        Obj2ndTargetPixel = (val & 1 << 12) != 0;
        Bd2ndTargetPixel = (val & 1 << 13) != 0;
    }
