...
| TONC       | Txt SE2                  | :heavy_check_mark: | Quite tight timings to pass this                                                                                |
...
| zayd       | dmaslow                  | :x:                | One cycle off on 3 prefetch tests so far |
| zayd       | dmamedium                | :x:                | One cycle off on 3 prefetch tests so far                                                                                                                                   |
| zayd       | dmamedium2               | :x:                | One cycle off on 3 prefetch tests so far |
| zayd       | dmafast                  | :heavy_check_mark: |  |
| NBA        | IRQ Delay                | :x: | Was working but now displays wrong lol irq lines compared to hardware since fixes for issue #82                                                                                                                                                                  |
| NBA        | DMA - Burst into tears   | :heavy_check_mark: | Required fixing the DMA timing to not trigger prefetch |
